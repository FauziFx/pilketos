$(document).ready(function(){
	...
	tinymce.init({
		selector:"textarea",
		menubar: false,
	    plugins: ["preview wordcount advlist autolink lists link image charmap preview pagebreak searchreplace insertdatetime, fullscreen hr , table,  directionality, textcolor, colorpicker, textpattern, code"],
	    toolbar: "undo redo | fontselect fontsizeselect | styleselect | bullist numlist | forecolor backcolor | preview wordcount",
	    convert_urls: false,
